 ...
 *
 */
public abstract class AbstractAutomaton implements Automaton, AutomatonBuilder {
	...
	protected StringWriter imageWriter() {
		...
		out.println(states);
		out.println("Initial states ("+ getInitialStates().size() + ") :");
		out.println(getInitialStates());
		out.println("Accepting states ("+ acceptingStates.size() + ") :");
